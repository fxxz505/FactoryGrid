...
export const buildings: BuildingDefinition[] = [
  ...
  { id: 'belt', name: '传送带', kind: 'belt', hotkey: 'B', durationTicks: 1, description: '沿当前方向逐格运输一个物品。' },
  ...
  { id: 'furnace', name: '熔炉', kind: 'processor', hotkey: 'V', durationTicks: 34, description: '同时接收矿物与煤矿，烧制铁锭或铜锭。' },
  ...
  { id: 'hub', name: '枢纽', kind: 'hub', hotkey: 'H', durationTicks: 1, description: '接收目标物品并推进交付进度。' }
]
